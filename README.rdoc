...
{<img src="https://travis-ci.org/dioteos/mongoid-autoinc.png" />}[![Build Status](https://travis-ci.org/dioteos/mongoid-autoinc.png)](https://travis-ci.org/dioteos/mongoid-autoinc)
